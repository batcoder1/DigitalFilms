...
export const CONFIGURATION = '/movies/configuration';
export const MOVIES_SEARCH = '/movies/search';
export const USER = '/user';
export const FAVORITES = '/user/favorites';
export const BASE_URL = 'http://localhost:3001';
export const TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVhMTlkZGVhMzg4Y2JhMDAxNGRjMjc2NCIsImlhdCI6MTUxMTY0NDY1N30.YCnHq8zACrG5dCtiaAtHth3EqtK604Z2vy-6qTSzn-w'
